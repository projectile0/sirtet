...
def start_game():
    ...
    while True:
        ...
        render_game_name()
        render_score(im_background, score)
        render_next_tetromino(im_background, None)  # Вместо None, вставляем переменную, в которой хранится фигура
...
def render_score(surface_static, score):  # Счет игры
...
def render_next_tetromino(surface_static, name_picture_tetromino):  # Следующая фигура
    font = pg.font.Font(None, 35)
